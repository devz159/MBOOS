...
<div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>/admin/product_category">Manage Product Categories</a><span class="divider">&raquo;</span></li>
				...
				<div class="widget-block">
					...
					<div class="widget-content">
						...
						<div id="register_msg_error">
							...
							<form class="form-horizontal well white-box" action="<?php echo base_url(); ?>admin/product_category/add_product_category_validate" method="post" accept-charset="utf-8" enctype="multipart/form-data">
								<fieldset id="add_item_fieldset">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="input-xlarge text-tip" title="Category Name" name="product_category_name" value="<?php echo set_value('product_category_name'); ?>" />				
										</div>
									</div>
